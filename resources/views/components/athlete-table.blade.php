            ...
            <tr class="dark:bg-gray-900">
                <th scope="col" class="px-3 py-3" colspan="{{ count($columns) - 0 }}">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between sm:gap-4 w-full">
                        ...
                        <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-600 whitespace-nowrap text-left sm:text-right sm:ml-auto mt-2 sm:mt-0" title="Last updated: {{ $ratings_last_processed }}">
                            Last updated: {{ $ratings_last_processed ?? '—' }}
                        </p>
                    </div>
                </th>
            ...
            <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200 w-16 athlete-row">
                ...
                <td class="px-1 py-4 athlete-name">
                    @if(!empty($athlete->ratings_central_id))
                        <!-- <a href="https://www.ratingscentral.com/PlayerHistory.php?PlayerID={{ $athlete->ratings_central_id }}" class="text-blue-500 hover:underline" target="_blank"> -->
