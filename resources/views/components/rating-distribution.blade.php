...
<div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6 inline-block">
  ...
  <div class="explanation text-sm text-gray-500 dark:text-gray-400 mb-4 w-full text-left">
    This chart displays the rating distribution of active athletes in the <strong class="text-gray-900 dark:text-white">currently filtered</strong> QLD ladder of {{ $ratedAthletes->count() }} {{ Str::plural('athlete', $ratedAthletes->count()) }}.
    </div>
